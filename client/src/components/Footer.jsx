...
const Footer = () => {
    return (
        <footer className="bg-amber-50 pt-20 pb-10 border-t border-amber-100">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.linkedin.com/company/vernovate-pvt-ltd-page/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center text-gray-700 hover:bg-vernovate-primary hover:text-white transition-colors">
                                <Linkedin size={20} />
                            </a>
                            <a href="https://www.instagram.com/vernovate/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center text-gray-700 hover:bg-vernovate-primary hover:text-white transition-colors">
                                <Instagram size={20} />
                            </a>
                            <a href="mailto:vernovate@gmail.com" className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center text-gray-700 hover:bg-vernovate-primary hover:text-white transition-colors">
                                <Mail size={20} />
                            </a>
                        </div>
                    </div>
                ...
                <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        <Link to="/privacy" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors">Privacy Policy</Link>
                        <Link to="/terms" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors">Terms of Service</Link>
                    </div>
                </div>
            </div>
        </footer>
