...
const ProjectDetail = () => {
    ...
    if (!project) return <div className="min-h-screen flex items-center justify-center text-black">Loading...</div>;

    return (
        <div className="min-h-screen text-black pt-0">
            <SEO
                title={project.title}
                path={`/projects/${id}`}
                description={project.shortDescription}
                keywords={`Vernovate, ${project.title}, ${project.category}, case study, ${project.category.toLowerCase()} solutions India`}
            />
