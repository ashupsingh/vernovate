    ...
    return (
        <div className="min-h-screen pt-0">
            <SEO
                title={service.title}
                path={`/services/${id}`}
                description={`${service.title} by Vernovate — expert ${service.title.toLowerCase()} services for businesses. Custom solutions built with cutting-edge technology. Trusted by enterprises across India.`}
                keywords={`Vernovate ${service.title}, ${service.title.toLowerCase()} company India, ${service.title.toLowerCase()} services Guwahati, technology solutions`}
            />
            {/* Hero Section */}
            {/* Hero Section */}
            <section className="bg-black text-white relative overflow-hidden min-h-[55vh] md:min-h-[60vh] flex flex-col justify-center md:justify-end pt-24 pb-12 md:pt-32 md:pb-20">
                ...
                {/* Breadcrumb & Back link pinned to top */}
                <div className="absolute top-14 md:top-8 left-0 right-0 z-20 container mx-auto px-4">
                    <nav className="hidden md:flex text-sm text-gray-400 mb-2 items-center space-x-2">
                    ...
                    <Link to="/services" className="inline-flex items-center text-white/80 hover:text-white transition-colors text-sm font-medium group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                            ...
                            <div className="bg-black text-white p-8 rounded-2xl text-center">
                                ...
                                <Button variant="primary" className="w-full justify-center" onClick={() => setIsProjectModalOpen(true)}>Start a Project</Button>
                            </div>
                        </div>
                    </div>
                </div>
